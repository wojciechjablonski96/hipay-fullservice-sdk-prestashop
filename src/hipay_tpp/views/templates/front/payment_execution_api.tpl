...
{/if}
    ...
    <form enctype="application/x-www-form-urlencoded" class="form-horizontal" action="{$link->getModuleLink('hipay_tpp', 'paymentapi', [], true)|escape:'html'}" method="post" name="tokenizerForm" id="tokenizerForm" autocomplete="off">
