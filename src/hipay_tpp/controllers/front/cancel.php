 ...
 * @since 1.5.0
 */
class HiPay_TppCancelModuleFrontController extends ModuleFrontController {
	/**
	 *
	...
	public function postProcess() {
        ...
        Hook::exec('displayHiPayCanceled', ['cart_id' => $cart_id, 'order_id' => Order::getOrderByCartId($cart_id)]);
