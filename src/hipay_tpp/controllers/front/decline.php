 ...
 * @since 1.5.0
 */
class HiPay_TppDeclineModuleFrontController extends ModuleFrontController {
	/**
	 *
	...
	public function postProcess() {
        ...
        Hook::exec('displayHiPayDeclined', array('cart_id' => $cart_id, 'order_id' => Order::getOrderByCartId($cart_id)));
